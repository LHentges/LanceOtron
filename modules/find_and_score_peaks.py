...
with open(out_folder+out_file_name, 'w', newline='') as f:
    if not skip_header:
        f.write('chrom\tstart\tend\toverall_peak_score\tshape_score\tpvalue_score\tpvalue_chrom\tpvalue_10kb\tpvalue_20kb\tpvalue_30kb\tpvalue_40kb\tpvalue_50kb\tpvalue_60kb\tpvalue_70kb\tpvalue_80kb\tpvalue_90kb\tpvalue_100kb\n')
